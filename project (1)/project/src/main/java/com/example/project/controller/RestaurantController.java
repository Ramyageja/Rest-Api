...
import com.example.project.serviceimpl.ServiceImplement;
 ...
 * In this Mapping ,we get all the restaurant details in the form of Swiggy model object   */
	...
	public ResponseEntity<SwiggyModel> updatehotelById(@PathVariable("hotelId") int id,@RequestBody SwiggyModel hotel){
